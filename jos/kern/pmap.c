...
// returned physical page with '\0' bytes.  Does NOT increase the reference
...
{
	// Fill this function in
	// This pointer points to the page tale address in page directory
	...
	if (*pt_addr & PTE_P) {
		...
		if (create == false) {
			...
			if (new_pg == NULL) {
				...
				// Write the physical address in page directiry
